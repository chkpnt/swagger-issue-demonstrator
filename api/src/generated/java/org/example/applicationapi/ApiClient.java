package org.example.applicationapi;
...
import org.example.applicationapi.auth.ApiKeyAuth;
import org.example.applicationapi.auth.Authentication;
import org.example.applicationapi.auth.HttpBasicAuth;
import org.example.applicationapi.auth.OAuth;
...
public class ApiClient {
    ...
    public <T> T deserialize(Response response, GenericType<T> returnType) throws ApiException {
        ...
        if (contentTypes != null && !contentTypes.isEmpty()) contentType = String.valueOf(contentTypes.get(0));
    ...
    public File prepareDownloadFile(Response response) throws IOException {
        ...
        if (tempFolderPath == null) return Files.createTempFile(prefix, suffix).toFile();
            ...
            return Files.createTempFile(Paths.get(tempFolderPath), prefix, suffix)
                    .toFile();
    }
